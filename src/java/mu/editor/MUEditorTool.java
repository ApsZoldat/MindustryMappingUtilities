...
public enum MUEditorTool{
            ...
            if(mode == 0 || mode == -1){
                ...
                setter = t -> {
                    if(editor.drawBlock.saveData){
                        editor.addTileOp(TileOp.get(t.x, t.y, 5, TileOpData.get(t.data, t.floorData, t.overlayData)));
                        editor.addTileOp(TileOp.get(t.x, t.y, 6, t.extraData));
                    }
    ...
    public static final MUEditorTool[] all = values();
    ...
    MUEditorTool(KeyCode code){
        this(new String[]{});
        this.key = code;
    }

    MUEditorTool(String... altModes){
        this.altModes = altModes;
    }

    MUEditorTool(KeyCode code, String... altModes){
        this.altModes = altModes;
        this.key = code;
    }
